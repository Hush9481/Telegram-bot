...
bot.hears('Головы сият..', (ctx) => ctx.reply('Головы сияют на моей едкой катане Голоса этих ублюдков по пятам бегут за нами Погруженный в Изанами, все колёса под глазами Её взгляд убьёт любого, её взгляд убьёт цунами Похоронный марш гулей, на часах последний тик Моя thottie — Бравл Шелли, я несу ей дробовик Ваши головы — мишени, я снесу их в один миг Никаких резких движений, ваш хилбар на один  (А-а) Диномайк, триплл килл (Ха), нервы на пределе Войс в моих ушах, я позабыл все дни недели Я убийца по природе всех амбиций в твоём лобби'))
